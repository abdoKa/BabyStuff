 ...
 */
final class Version20190423164431 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, fourniseur_id INT NOT NULL, categorie_id INT NOT NULL, referance VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, prix NUMERIC(6, 2) NOT NULL, features TINYINT(1) NOT NULL, stock INT NOT NULL, slug VARCHAR(170) NOT NULL, date_ajout DATETIME NOT NULL, date_modif DATETIME NOT NULL, INDEX IDX_29A5EC2731D5B51F (fourniseur_id), INDEX IDX_29A5EC27BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
